...
void UserLogin::Unmarshal()
{
    ...
    Utils::print(QString("UserLogin userid: %1, localsid: %2, blkickuser: %3, freecreatime: %4, ip: %5")
                 .arg(userid).arg(localsid).arg(blkickuser == 0 ? "false" : "true").arg(freecreatime).arg(loginip));
